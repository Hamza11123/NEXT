      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover object-center rounded" src={`../${product.productImgURL}`} />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{product.productTitle}</h1>
              ...
              <div className="flex">
                ...
                <button onClick={() => { AddToCart(slug, product.productTitle, 1, '$343') }} className="flex ml-6 text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Add To Cart</button>
              ...
              <div className='flex items-center mt-4'>
                <input onChange={ChangeText} value={PinCode} placeholder='Enter Your City-Zip-Code' className='h-8 p-2 border-2 border-red-300' type="text" />
                <button className='flex ml-6 text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded' onClick={fetchPins}>Check</button>
              ...
              {/* If The PinCodes is not 'null' then, print one of two messages, either we deliver our services there or not! */}
              {
                (PinCodes !== null) ? // PinCodes-State-Variable Must Have 'Array-Of-Codes(String)' To Move Further
                  (PinCodes.includes(PinCode)) ?  // Returns 'Boolean', for 'true' The Entered Code Must Exist In The 'Array-Of-Codes(String)'
                    <p className='text-green-700'>Yes! :) We Deliver Our Services Here</p>
                    : <p className='text-red-700'> Sorry! Our Service Isn't Available Here</p>
                  : ''
              }
            </div>
          </div>
